...
export const getColumnOrder = (groupBy) => {
  const allColumns = [
    ...
    { key: 'courseVersion', label: 'Version', sortKey: 'courseVersion' },
    { key: 'participantTag', label: 'Tag', sortKey: 'participantTag' },
    { key: 'participantExternalId', label: 'External ID', sortKey: 'participantExternalId' },
